...
**The test suite.** 1,588 passing, 2 skipped, 4 `xfail`, green across repeated runs under random ordering. It was not green until recently, and the way it got there is worth recording because the diagnosis in this file was wrong twice.
