...
const GLOBAL: { keys: string; label: string }[] = [
  ...
  { keys: "Cmd Shift S", label: "save as: a named state you can return to" },
  { keys: "Cmd Z", label: "undo" },
  { keys: "Cmd Shift Z", label: "redo" },
  { keys: "Cmd C", label: "copy selected object" },
  { keys: "Cmd V", label: "paste object" },
  { keys: "Cmd A", label: "select every visible, unlocked object" },
  { keys: "Cmd Shift A", label: "select everything of the same class" },
